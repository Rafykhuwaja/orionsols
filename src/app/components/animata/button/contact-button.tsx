  ...
  return (
    <div className="min-h-12 w-48">
      ...
      >
        <span
          className={cn(
            "transition-colors duration-100 ease-in-out text-white group-hover:text-amber-400",
          )}
        >
          {text}
        </span>
        <div
          className={cn(
            ...
            "bg-orange-300 group-hover:bg-amber-100",
          )}
        >
          <div className="absolute left-0 flex h-7 w-14 -translate-x-1/2 items-center justify-center transition-all duration-200 ease-in-out group-hover:translate-x-0">
            <ArrowRight
              size={16}
              className={cn(
                "size-7 transform p-1 text-orange-300 opacity-0 group-hover:opacity-100",
              )}
            />
            <ArrowRight
              size={16}
