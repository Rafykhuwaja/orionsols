...
export default function FlipCard({
  ...
  return (
    <div className={cn("group h-[550px] md:w-[22vw] [perspective:1000px]", className)} {...props}>
      <div
        className={cn(
  ...
  />
  <div className="absolute bottom-4 left-4 text-xl font-bold text-white bg-gray-950 px-4 py-2">{title}</div>
</div>
