...
function ContactBanner() {
  return (
    <div className="flex flex-col-reverse md:flex-row ContactBackground px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32 text-white top-0 md:pt-24 w-full md:fixed md:z-[-1]">
      {/* Image Section */}
