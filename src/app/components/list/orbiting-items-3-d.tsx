...
export const CenterIcon = (
  ...
  alt="icon"
  fill
    className="center z-0 h-32 w-32 animate-float rounded-full "
      ...
      >
        ...
        {items.map((item, index) => {
          return (
            <div
              key={index}
              className="absolute flex h-20 w-20 items-center justify-center rounded-full   transition-transform duration-500 ease-out"
