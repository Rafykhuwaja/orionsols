...
function WhyChoosUsSection() {
  return (
    <div className="px-4 md:px-10 lg:px-20 flex flex-col md:flex-row justify-center items-center py-10 md:py-36  bg-gray-900 md:mt-[760px]">
...
export default WhyChoosUsSection;
    ...
    <div className="px-4 md:px-10 lg:px-20 flex flex-col md:flex-row justify-center items-center py-10 md:py-36  bg-gray-900 md:mt-[785px] m">
      <div className="w-full md:w-1/2 rounded-lg">
        <div className="bg-[#ff9c00]  w-full rounded-lg fadeInLeft">
          <img
            src="/images/Image1.jpg"
      ...
      <div className="w-full md:w-1/2 relative bottom-8 fadeInRight md:ml-7">
        <h1 className="text-3xl  text-[#ff9c00] font-extrabold mb-5 md:mt-16 mt-10 md:text-6xl">
