  ...
  return (
    <div>
      ...
      <div className=" text-white md:px-[200px] md:py-[100px] px-3 py-6">
        ...
        <h2 className="text-[#b8a9fe] text-2xl font-bold my-6">Interest</h2>
        <p className="text-lg">
        ...
        <h2 className="text-[#b8a9fe] text-2xl font-bold my-6">Conversion</h2>
        <p className="text-lg">
        ...
        <h2 className="text-[#b8a9fe] text-2xl font-bold my-6">Advocacy</h2>
        <p className="text-lg">
        ...
        <h2 className="text-[#b8a9fe] text-xl font-bold my-6">
        ...
        <h2 className="text-[#b8a9fe] text2xl font-bold my-6">
        ...
        <h2 className="text-[#b8a9fe] text-xl font-bold my-6">Conclusion</h2>
        <p className="text-lg">
